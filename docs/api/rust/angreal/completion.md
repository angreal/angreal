...
```rust
fn for_current_shell () -> Result < Self >
```
...
### `enum Shell` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>
...
### `fn auto_install_completion`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn auto_install_completion () -> Result < () >
```
...
### `fn force_install_completion`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn force_install_completion (shell : Option < & str >) -> Result < () >
```
...
```rust
fn uninstall_completion (shell : Option < & str >) -> Result < () >
```
...
```rust
fn show_completion_status () -> Result < () >
```
...
```rust
fn generate_completions (args : & [String]) -> Result < Vec < String > >
```
...
### `fn get_nested_command_completions`
