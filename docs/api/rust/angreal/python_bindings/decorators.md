...
> **Python API**: [angreal.python_bindings.decorators.GroupDecorator](../../../angreal/python_bindings/decorators.md#class-groupdecorator)
...
> **Python API**: [angreal.python_bindings.decorators.GroupDecorator.__call__](../../../angreal/python_bindings/decorators.md#__call__)
...
> **Python API**: [angreal.python_bindings.decorators.CommandDecorator](../../../angreal/python_bindings/decorators.md#class-commanddecorator)
...
> **Python API**: [angreal.python_bindings.decorators.CommandDecorator.__call__](../../../angreal/python_bindings/decorators.md#__call__)
...
> **Python API**: [angreal.python_bindings.decorators.ArgumentDecorator](../../../angreal/python_bindings/decorators.md#class-argumentdecorator)
...
> **Python API**: [angreal.python_bindings.decorators.ArgumentDecorator.__call__](../../../angreal/python_bindings/decorators.md#__call__)
...
> **Python API**: [angreal.python_bindings.decorators.required_version](../../../angreal/python_bindings/decorators.md#required_version)

```rust
fn required_version (specifier : & str) -> PyResult < () >
```
...
### `fn register_decorators`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn register_decorators (_py : Python , m : & Bound < '_ , PyModule >) -> PyResult < () >
```
...
> **Python API**: [angreal.python_bindings.decorators.group](../../../angreal/python_bindings/decorators.md#group)

```rust
fn group (kwargs : Option < & Bound < '_ , PyDict > >) -> PyResult < GroupDecorator >
```
...
> **Python API**: [angreal.python_bindings.decorators.command_group](../../../angreal/python_bindings/decorators.md#command_group)

```rust
fn command_group (name : & str , about : Option < & str >) -> PyResult < GroupDecorator >
```
...
> **Python API**: [angreal.python_bindings.decorators.command](../../../angreal/python_bindings/decorators.md#command)

```rust
fn command (kwargs : Option < & Bound < '_ , PyDict > >) -> PyResult < CommandDecorator >
```
...
> **Python API**: [angreal.python_bindings.decorators.argument](../../../angreal/python_bindings/decorators.md#argument)

```rust
fn argument (kwargs : Option < & Bound < '_ , PyDict > >) -> PyResult < ArgumentDecorator >
```
